        ...
        <>
            <div className="max-w-screen-xl mx-auto justify-center items-center">
                ...
                <div className="flex justify-between pt-4 pr-1">
                    ...
                    <div className="pl-3 w-[500px] font-[Sans] font-medium text-[28px]">
                        {/* Items */}
                        <div className="flex items-center border-l-8 h-16 border-[#FFA600] pl-4 mb-4 border-b">
                            <p className="w-full pl-2">No contacts, ever</p>
                        </div>
                        <div className="flex items-center border-l-8 h-16 border-[#071E3E] pl-4 mb-4 border-b">
                            <p className="w-full pl-2">Autonomy & responsibility</p>
                        </div>
                        <div className="flex items-center border-l-8 h-16 border-[#00B4EE] pl-4 mb-4 border-b">
                            <p className="w-full pl-2">No external investors</p>
                        </div>
                        <div className="flex items-center border-l-8 h-16 border-[#B00500] pl-4 border-b">
