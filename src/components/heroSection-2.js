...
function HeroSection2(){
    ...
    <div className="grid grid-cols-3 gap-4 p-9 pl-14 pr-14">
      {/* Block-1 */}
    <div
        className="p-4 h-[340px] xl:col-span-1 relative col-span-3"
        style={{
      ...
      {/* Block-2 */}
      <div className="relative bg-[#181E4E] pl-6 pt-6 h-[340px] xl:col-span-1 col-span-3">
        ...
        {/* Block-3 */}
        <div
          className="relative p-4 h-[340px] flex flex-col justify-end xl:col-span-1 col-span-3"
          style={{
        ...
        {/* Block-4 */}
      <div className="bg-[#6D6388] h-[340px] pl-9 pr-9 pt-5 sm:pt-16 xl:col-span-2 col-span-3">
      ...
      {/* Block-5 */}
      <div
        className="p-4 h-[340px] xl:col-span-1 col-span-3 relative"
        style={{
      ...
      {/* Block-6 */}
      <div
        className="p-4 h-[340px] relative xl:col-span-1 col-span-3"
        style={{
          backgroundImage: `linear-gradient(180deg, rgba(0, 0, 0, 0) 60%, #000000 75%), url(${Img1})`,
          backgroundSize: 'cover',
          backgroundPosition: 'center',
      ...
      {/* Block-7 */}
      <div className="relative bg-[#181E4E] pl-9 pt-14 h-[340px] xl:col-span-2 col-span-3">
      <p className="text-2xl text-white font-[Lato] font-bold leading-9 sm:pr-[280px]">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
      ...
      {/* Block-8 */}
      <div className="relative bg-[#4B587C] pt-8 pr-8 pl-8 h-[340px] xl:col-span-1 col-span-3">
      ...
      {/* Block-9 */}
      <div className="relative pl-8 pr-8 h-[340px] xl:col-span-1 col-span-3" style={{
    ...
    <button className="mt-4 text-white font-[Sans] text-sm text-left font-bold leading-[21px] cursor-pointer">LEARN MORE</button>
      ...
      {/* Block-10 */}
      <div className="relative pl-9 pr-8 h-[340px] xl:col-span-1 col-span-3" style={{backgroundImage: `url(${Img8})`, backgroundSize: 'cover',
          backgroundPosition: 'center'}}>
        <div className="absolute inset-0 flex flex-col justify-end p-9">
      ...
      {/* Block-11 */}
      <div className="relative pl-9 pr-8 h-[340px] xl:col-span-1 col-span-3" style={{backgroundImage: `url(${Img9})`, backgroundSize: 'cover',
          backgroundPosition: 'center'}}>
        <div className="absolute inset-0 flex flex-col justify-end p-9">
          <h2 className="text-2xl text-white font-[Lato] font-bold leading-9">Understanding Your Business</h2>
          <button className="mt-4 text-white font-[Sans] text-sm text-left font-bold leading-[21px] cursor-pointer">LEARN MORE</button>
      ...
      {/* Block-12 */}
      <div className="bg-[#4B587C] h-[340px] pl-9 pr-9 pt-5 sm:pt-16 xl:col-span-2 col-span-3">
        <p className="text-2xl text-white font-[Lato] font-bold leading-9">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
          Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, </p>
          <br></br>
        <p className="mt-2 text-white font-[Sans] text-[22px] leading-[33px] font-bold">Johan Horak</p>
